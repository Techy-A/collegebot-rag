...
STRICT RULES:
1. Answer ONLY from the provided CONTEXT below.  Do not use prior knowledge.
...
3. Never invent deadlines, fee amounts, names, dates, or policy details.
4. Use bullet points for any list of three or more items.
5. Cite the source document name when it is present in the metadata.
...
with st.sidebar:
    ...
    temperature = st.slider("Temperature", 0.0, 1.0, 0.15, 0.05,
                            help="Keep below 0.25 for factual Q-A.")
